                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        width: 260.w,
                        child: CustomText(" ${details.startPoint}",
                            Colors.black, FontWeight.bold, 15.sp),
                      ),
                    ],
                  ),
                    TripDetailsWidget(title: "Destination", value: details.destination),
                           TripDetailsWidget( title: "Passenger" ,value: details.bids![0].passenger.toString()),
                     TripDetailsWidget(title:"Pay", value: details.pay),
                      TripDetailsWidget( title: "Bid Amount" ,value: details.bids![0].amount.toString()),
                             TripDetailsWidget( title: "Agree" ,value: details.bids![0].agree.toString())
                ],
              );
            }), 
                                                              ...
                                                              height: 40,
                                                                ...
                                                                onTab: () {
                                                                  ...
                                                                  var _isValid = _formOfferkey
                                                                      ...
                                                                      .validate();
                                                                  if (_isValid) {
                                                                controller.bidOnTrip(amount.text.toString(),id, seat, shortmessage.text.toString());
                                                                  } else {
                                                                    Get.snackbar(
                                                                        "",
                                                                        "Offer not submitted");
    ...
    children: [
      ...
      Container(
        ...
        child: CustomText(" ${value}",
            Colors.black, FontWeight.w500, 15.sp),
      ),
    ],
                  );
  }
